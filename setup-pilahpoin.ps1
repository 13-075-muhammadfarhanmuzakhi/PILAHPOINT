# ================================================================
#  PilahPoin - Platform Penukaran Sampah Digital
#  Setup Script untuk PowerShell (VS Code Terminal)
# ================================================================
#  CARA PAKAI:
#    1. Simpan file ini di folder mana saja (misal: C:\Projects\)
#    2. Buka terminal VS Code di folder tersebut
#    3. Jalankan: Set-ExecutionPolicy -Scope CurrentUser Unrestricted
#    4. Lalu: .\setup-pilahpoin.ps1
#    5. Setelah selesai: cd pilahpoin && npm run dev
# ================================================================
...
Write-Host ""
Write-Host "  ♻️  PilahPoin Setup Script" -ForegroundColor Green
Write-Host "  Platform Penukaran Sampah Digital" -ForegroundColor DarkGreen
Write-Host "  ─────────────────────────────────" -ForegroundColor DarkGreen
Write-Host ""

# ── Step 1: Buat project Vite React ──────────────────────────
Write-Host "[1/4] Membuat project Vite React..." -ForegroundColor Cyan
npm create vite@latest pilahpoin -- --template react

if (!(Test-Path "pilahpoin")) {
    Write-Host "Gagal membuat project. Pastikan Node.js terinstall!" -ForegroundColor Red
    exit 1
}

Set-Location pilahpoin

# ── Step 2: Install dependencies ─────────────────────────────
Write-Host "[2/4] Menginstall dependencies..." -ForegroundColor Cyan
npm install react-router-dom leaflet react-leaflet lucide-react

# ── Step 3: Buat struktur folder ─────────────────────────────
Write-Host "[3/4] Menyiapkan struktur folder..." -ForegroundColor Cyan
...
# ── Step 4: Tulis semua file ──────────────────────────────────
Write-Host "[4/4] Menulis semua file komponen..." -ForegroundColor Cyan
...
'@ | Set-Content "src/context/AppContext.jsx" -Encoding UTF8
...
'@ | Set-Content "src/pages/Login.jsx" -Encoding UTF8
...
'@ | Set-Content "src/components/MapView.jsx" -Encoding UTF8
...
'@ | Set-Content "src/components/HamburgerMenu.jsx" -Encoding UTF8
...
# ════════════════════════════════════════════════════════════
Write-Host ""
Write-Host "  ✅  Setup PilahPoin selesai!" -ForegroundColor Green
Write-Host "  ─────────────────────────────────" -ForegroundColor DarkGreen
Write-Host ""
Write-Host "  Jalankan aplikasi dengan perintah:" -ForegroundColor White
Write-Host ""
Write-Host "     npm run dev" -ForegroundColor Yellow
Write-Host ""
Write-Host "  Lalu buka browser: http://localhost:5173" -ForegroundColor Cyan
Write-Host ""
Write-Host "  📱 Fitur yang tersedia:" -ForegroundColor White
Write-Host "     • Login & Register (simulasi)"
Write-Host "     • Dashboard saldo & poin"
Write-Host "     • Scan AI Image Recognition (simulasi)"
Write-Host "     • Peta titik pengumpulan (Bandar Lampung)"
Write-Host "     • Hamburger menu: Profil, Statistik, Notifikasi,"
Write-Host "       Voucher, Dark/Light Mode, Logout"
Write-Host "     • Riwayat transaksi"
Write-Host ""
